...
export default function GitHubActivitySection() {
  ...
  const [ghUser, setGhUser] = useState({
    login: "vivek-chauhaan",
    public_repos: 0,
    followers: 0,
    html_url: "https://github.com/vivek-chauhaan",
  ...
  const githubLink =
    links?.find((l) => l.platform?.toLowerCase().includes("github"))?.url ||
    "https://github.com/vivek-chauhaan";

  const username =
    githubLink.split("/").filter(Boolean).pop() || "vivek-chauhaan";
  ...
  return (
    <section id="github" className="max-w-7xl mx-auto px-5 md:px-8 py-20">
      <SectionTitle
        ...
        subtitle="Building projects, exploring modern technologies, and continuously improving my development skills."
      />
        ...
        >
          ...
          <div>
              ...
              <div className="flex items-center gap-3">
                {ghUser.avatar_url ? (
                  <img
                    ...
                    alt={ghUser.name || username}
                    className="w-12 h-12 rounded-2xl border border-white/20 object-cover shadow-md"
                  />
                ) : (
            ...
            <p className="text-slate-300 text-sm leading-relaxed mb-6">
              Full Stack MERN Developer building modern web applications with
