...
export default function Hero() {
  ...
  const designation =
    about?.designation || "Java Backend & Full Stack Developer";
  const description =
    about?.description ||
    "Crafting high-performance Java & Spring Boot backends, scalable REST microservices, and modern React user interfaces with clean architecture.";
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8 grid lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7">
          ...
          <motion.h1
            ...
            className="font-display text-4xl sm:text-5xl md:text-5xl font-bold leading-tight tracking-tight text-slate-900 dark:text-white"
          >
            Hi, I'm{" "}
          ...
          <motion.p
            ...
            className="mt-6 text-slate-600 dark:text-slate-300 text-base md:text-base max-w-xl leading-relaxed font-normal"
          >
            {description}
          </motion.p>
          ...
          >
            <span className="text-xs font-bold uppercase tracking-wider text-slate-400 shrink-0 leading-none">
              CONNECT:
            </span>
          ...
          <div className="relative w-full max-w-lg rounded-2xl bg-slate-950 border border-slate-800 shadow-2xl shadow-black/50 overflow-hidden font-mono text-xs text-slate-300">
            ...
            <div className="p-5 space-y-2 overflow-x-auto leading-relaxed">
              <p className="text-slate-500">
                // Portfolio Architecture & Profile
              </p>
              ...
              <p className="pl-4">
                ...
                <span className="text-emerald-300">"2+ Years"</span>,
              </p>
